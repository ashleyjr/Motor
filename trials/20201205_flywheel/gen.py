...
# Prongs
prong_width=15
x=Part.makeBox(2*int_wheel_rad,prong_width,wheel_depth)
x.translate(Base.Vector(-int_wheel_rad,-(prong_width/2),0))
wheel=Part.makeCompound([wheel,x])

y=Part.makeBox(2*int_wheel_rad,prong_width,wheel_depth)
...
stick.translate(Base.Vector(0,0,wheel_depth))
...
star=Part.Face(star)
star=star.extrude(Base.Vector(0,0,wheel_depth+stick_depth))
